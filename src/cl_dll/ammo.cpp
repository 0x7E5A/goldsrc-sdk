...
#include "inc/hud.h"
#include "cl_dll/inc/util.h"
#include "cl_dll/inc/parsemsg.h"

#include <string.h>
#include <stdio.h>

#include "cl_dll/inc/ammohistory.h"
...
HSPRITE_* WeaponsResource :: GetAmmoPicFromWeapon( int iAmmoId, wrect_t& rect )
{
	for ( int i = 0; i < MAX_WEAPONS; i++ )
	{
