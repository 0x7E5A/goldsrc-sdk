...
{
	// sprite handlers
	HSPRITE_ (*pfnSPR_Load)			( const char *szPicName );
	int		(*pfnSPR_Frames)		( HSPRITE_ hPic );
	int		(*pfnSPR_Height)		( HSPRITE_ hPic, int frame );
	int		(*pfnSPR_Width)			( HSPRITE_ hPic, int frame );
	void	(*pfnSPR_Set)			( HSPRITE_ hPic, int r, int g, int b );
	...
	void	(*pfnSetCrosshair)		( HSPRITE_ hspr, wrect_t rc, int r, int g, int b);
